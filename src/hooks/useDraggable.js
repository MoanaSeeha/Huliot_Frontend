import { getCorrectTouchPosition } from '@/utils'
import { useCallback, useRef, useState, useEffect } from 'react'

export function useDraggable({ controlStyle, viewport = false, rectLimits } = {}) {
  ...
  useEffect(() => {
    ...
    function startDragging(event) {
      ...
      const { clientX, clientY } = getCorrectTouchPosition(source)
